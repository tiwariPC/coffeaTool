...
def fillbranch(events,goodevent,weights,reg="sr1b"):
    events = events[goodevent]
    doc = {
          "DiJetMass":events.DiJetMass[:,0],"DiJetPt":events.DiJetPt[:,0],"DiJetEta":events.DiJetEta[:,0],"DiJetPhi":events.DiJetPhi[:,0],
