...
class MyProcessor(processor.ProcessorABC):
    ...
    def applypresel(self,events):
        ...
        events['updatedJet']=events.Jet[isClean(events.updatedJet,events.updatedElectron)]
        events['updatedJet']=events.Jet[isClean(events.updatedJet,events.updatedMuon)]
